...
namespace Lab05New.Migrations
{
    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "CompletionMarks",
                columns: table => new
                {
                    CompletionMarkId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CompletionMarks", x => x.CompletionMarkId);
                    table.ForeignKey(
                        name: "FK_CompletionMarks_AspNetUsers_ApplicationUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompletionMarks_ApplicationUserId",
