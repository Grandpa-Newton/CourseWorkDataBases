...
public partial class TestingSystemDbContext : DbContext
{
    ...
    public virtual DbSet<AnswersWithQuestion> AnswersWithQuestions { get; set; }

    public virtual DbSet<CompletionMark> CompletionMarks { get; set; }

    public virtual DbSet<Difficulty> Difficulties { get; set; }

    public virtual DbSet<NumberOfResult> NumberOfResults { get; set; }
    ...
    public virtual DbSet<TestsWithNumberOfQuestion> TestsWithNumberOfQuestions { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=MSI;Database=TestingSystemDb; Trusted_Connection=True;TrustServerCertificate=Yes;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<AnswersWithQuestion>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("AnswersWithQuestions");
        ...
        modelBuilder.Entity<CompletionMark>(entity =>
        {
            ...
            entity.Property(e => e.CompletionMark1).HasColumnName("CompletionMark");
        ...
        modelBuilder.Entity<NumberOfResult>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("NumberOfResults");
        ...
        modelBuilder.Entity<TestsWithNumberOfQuestion>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("TestsWithNumberOfQuestions");
